...
from seahub.api2.endpoints.repo_trash import RepoTrash, RepoTrashItem
...
urlpatterns = patterns(
    ...
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/trash-item/$', RepoTrashItem.as_view(), name='api-v2.1-repo-trash-item'),
